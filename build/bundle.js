...
/***/ function(module, exports, __webpack_require__) {
	...
	var azure = __webpack_require__(3);
	...
	function lastLogCheckpoint(req, res) {
	  ...
	  var required_settings = ['AUTH0_DOMAIN', 'AUTH0_CLIENT_ID', 'AUTH0_CLIENT_SECRET', 'STORAGE_ACCOUNT_NAME', 'STORAGE_ACCOUNT_KEY', 'STORAGE_CONTAINER_NAME'];
	  ...
	  req.webtaskContext.storage.get(function (err, data) {
	    ...
	    var blobService = azure.createBlobService(ctx.data.STORAGE_ACCOUNT_NAME, ctx.data.STORAGE_ACCOUNT_KEY);

	    // Start the process.
	    async.waterfall([function (callback) {
	      try {
	        blobService.createContainerIfNotExists(ctx.data.STORAGE_CONTAINER_NAME, function (err) {
	          return callback(err);
	        });
	      } catch (e) {
	        return callback(e);
